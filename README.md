...
2. Добавить валидацию с помощью pydantic
3. Понять куда деть функционал для админов и мастеров. Понятно, что делать их в одном боте не очень
4. Переделать UI под наши цели и определиться с основными концепциями
...
5. **Связь с поддержкой**
   ----Другой бот-------
6. **Для мастеров** (доступ только для мастеров, скрыто для обычных пользователей)
7. **Для админов** 
